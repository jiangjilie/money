 ...
 <fieldset>
			              ...
			              <fieldset>
			                  <div class="form-group" >
			                      <div  style="float: right;">
									...
									<a href="javascript:;" id="import" title="点击导入记录" onclick="inportExcel()" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-import" plain="true" group=""><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">导入税款</span><span class="l-btn-icon icon-import">&nbsp;</span></span></a>
		...
		<thead>
		  <tr style="background-color:#438eb9;color: #FFF;">
			...
			<th class="tr-th" style="text-align:center;padding:10px">证件类型</th>				
			<th class="tr-th" style="text-align:center;padding:10px">证件号码</th>				
			<th class="tr-th" style="text-align:center;padding:10px">税款所属期起</th>
			<th class="tr-th" style="text-align:center;padding:10px">税款所属期止</th>
			<th class="tr-th" style="text-align:center;padding:10px">所得项目</th>
			<th class="tr-th" style="text-align:center;padding:10px">本期收入</th>		
			<th class="tr-th" style="text-align:center;padding:10px">减除费用</th>
			<th class="tr-th" style="text-align:center;padding:10px">专项扣除</th>
			<th class="tr-th" style="text-align:center;padding:10px">子女教育扣除</th>
			<th class="tr-th" style="text-align:center;padding:10px">其他扣除</th>
			<th class="tr-th" style="text-align:center;padding:10px">税率</th>
			<th class="tr-th" style="text-align:center;padding:10px">应补(退)税额</th>
		...
		<center><h2 style='font-size:25px;text-align:center'>年度累计税额</h2></center>
		<table id="dg" style="word-break:break-all; word-wrap:break-all;" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
						...
						<thead>
						  <tr style="background-color:#438eb9;color: #FFF;">
							...
							<th class="tr-th" style="text-align:center;">累计税额</th>
							<!-- <th class="tr-th" style="text-align:center;">操作</th>										 -->
						  </tr>
			            </thead>
						<tr>
							<td colspan='4' style="text-align:center;">表中无数据存在！</td>
						</tr>
						</table>
		...
		<script>
			...
			$("#add").click(function(){
				...
				layer.open({
					 ...
					 closeBtn: 1,
					 anim: 2,
					 content: "tax_luru.php?user="+user,
					  // btn: ["", "取消"],
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				$('#dg').bootstrapTable('destroy'); //动态加载表格之前，先销毁表格
										...
										var search= "dept=" + dept + "&name=" + name+ "&nd=" + nd+"&company="+company ;
											$.ajax({
										...
										function excel_select(ids) {
											window.location.href= "excel_tax_select.php?id=" + ids ;
													}
									...
									var nd = $("#yf").val();
									 if(dept=="" &&  name=="" && nd==""&& yf=="" ){
											layer.open({
											 ...
											 offset:'t',  //设置弹出位置
											 shadeClose: true,
											 content: 'delete_tax.php?dept=' + dept + '&name=' + name + '&nd=' + nd+ '&yf=' + yf ,
											 ...
											 yes: function (index, layero) {
												 var thisIndex = index;
												  ...
												  layer.confirm('<h4 style="color:red;padding:5px5px;magin:2px;">警告：真的确定清空表中所有数据吗</h4></center>', { icon: 5, title: '提示' }, function (index) {
														window.location.href= "delete_tax_php.php?dept=" + dept + "&name=" + name + "&phone=" + phone ;										                                									                 
																																			});
																			},//layer嵌套  *****重要
														});
														}else{
			...
			<script>
				...
				function excel(){				
					...
					// window.open(url, "_blank");
					window.location.href= "excel_tax.php?dept=" + dept + "&name=" + name + "&nd=" + nd+ "&yf=" + yf+"&company="+company;
								}
