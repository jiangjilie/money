...
<html>
	...
	<?php
	 ...
	 <center><h4 style='color:red;padding:5px5px;magin:2px;'>确定删除以下</h4></center>
		...
		<tr id='company'>
			<td style='height:30px;width:65px;text-align:center'>所属公司:</td>
			<td><textarea class='txtarea' name='company' style="width:  400px;height: 24px;border: 0;"readonly><?php echo $company;?></textarea></td>
		</tr>
		...
		if($dept==''){
			echo" <script> document.getElementById('dept').style.display='none';</script>";
		}
		if($company==''){
			echo" <script> document.getElementById('company').style.display='none';</script>";
		}
