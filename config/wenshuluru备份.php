	...
	<center>
		...
		<div id="box1">
			<form action="wenshuluruphp.php" method="get">
				...
				<b class="p1">文号：</b><input type="text" name="WH" value="<?php echo $_GET['WH'];?>">
				<b class="p1">责任者：<input type="text" name="ZRZ" value="<?php echo $_GET['ZRZ'];?>">
				<b class="p1">日期：</b><input type="text" name="RQ"  value="<?php echo $_GET['RQ'];?>"><br>
...
/*updat语句 （更新数据）
 $update="update wsdam set WH='{$WH}',TM='{$TM}',ZRZ='{$ZRZ}' where DAH='{$DAH}'";
