	...
	<head>
			              ...
			              <fieldset>
			                  <div class="form-group" >
			                      <div  style="float: right;">
									 ...
									 <!-- <a href="javascript:" id="add" title="添加工资信息" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-add" plain="true" group=""><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">添加工资</span><span class="l-btn-icon icon-add">&nbsp;</span></span></a>												 -->
									<a href="javascript:;" id="import" title="点击导入记录" onclick="inportExcel()" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-import" plain="true" group=""><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">导入工资</span><span class="l-btn-icon icon-import">&nbsp;</span></span></a>
		...
		<thead>
		  <tr style="background-color:#438eb9;color: #FFF;">
			...
			<th class="tr-th" style="text-align:center;padding:10px">基础工资</th>				
			<th class="tr-th" style="text-align:center;padding:10px">浮动工资</th>				
			<th class="tr-th" style="text-align:center;padding:10px">月度绩效</th>
			<th class="tr-th" style="text-align:center;padding:10px">缺薪</th>
			<th class="tr-th" style="text-align:center;padding:10px">考核</th>
			<th class="tr-th" style="text-align:center;padding:10px">补贴</th>
			<th class="tr-th" style="text-align:center;padding:10px">应发合计</th>
			<th class="tr-th" style="text-align:center;padding:10px">公积金</th>
			<th class="tr-th" style="text-align:center;padding:10px">养老</th>
			<th class="tr-th" style="text-align:center;padding:10px">医疗</th>
			<th class="tr-th" style="text-align:center;padding:10px">失业</th>
			<th class="tr-th" style="text-align:center;padding:10px">个税</th>
			<th class="tr-th" style="text-align:center;padding:10px">实发合计</th>
		...
		<script>
			...
			$("#add").click(function(){
				...
				layer.open({
					 ...
					 closeBtn: 1,
					 anim: 2,
					 content: "salary_luru.php?user="+user,
					  // btn: ["", "取消"],
		...
		$("#button").click(function(){
					...
					success:function(msg){
									...
									var   data = eval("("+msg+")"); //将返回的json数据进解析，并赋给data									
										...
										function excel_select(ids) {
											window.location.href= "excel_salary_select.php?id=" + ids ;
													}
				...
				//修改
					function ShowEdit(id){
						...
						layer.open({
							 ...
							 closeBtn: 1,
							 anim: 2,
							 content: "salary_change.php?id=" + id,
							  // btn: ["", "取消"],
									...
									var nd = $("#yf").val();
									 if(dept=="" &&  name=="" && nd==""&& yf=="" ){
											layer.open({
											 ...
											 offset:'t',  //设置弹出位置
											 shadeClose: true,
											 content: 'delete_salary.php?dept=' + dept + '&name=' + name + '&nd=' + nd+ '&yf=' + yf ,
											 ...
											 yes: function (index, layero) {
												 var thisIndex = index;
												  ...
												  layer.confirm('<h4 style="color:red;padding:5px5px;magin:2px;">警告：真的确定清空表中所有数据吗</h4></center>', { icon: 5, title: '提示' }, function (index) {
														window.location.href= "delete_salary_php.php?dept=" + dept + "&name=" + name + "&phone=" + phone ;										                                									                 
																																			});
																			},//layer嵌套  *****重要
														});
														}else{
			...
			<script>
				...
				function excel(){				
					...
					// window.open(url, "_blank");
					window.location.href= "excel_salary.php?dept=" + dept + "&name=" + name + "&nd=" + nd+ "&yf=" + yf+"&company="+company;
								}
