							...
							<div class='box box-primary'>
								...
								<table>
									<tr>
									                           ...
									                           <td class='datab-2'><textarea class='txtarea' id='name'name='name'>{$row['name']}</textarea></td>
															   <td class='datab-1 tdtitle' style='display:none'>原姓名</td>
															   <td class='datab-2' style='display:none'><textarea class='txtarea' id='name'name='yname'>{$row['name']}</textarea></td>
																...
																<td class='datab-1 tdtitle' style='display:none'>原所属公司</td>
																	<td class='datab-2' style='display:none'>
																		<select name='ycompany' class='form-control' id='company' style='height:36px;outline:0;margin-top: -5px;color:black'>
																			<option value='{$row['company']}'>{$row['company']}</option>			              		            
																		</select>
																	</td>
																...
																<td class='datab-1 tdtitle' style='display:none'>原部门</td>
																<td class='datab-2' style='display:none'>
																<select name='ydept' class='form-control' id='dept' style='height:36px;outline:0;margin-top: -5px;color:black'>
																	<option value='{$row['dept']}'>{$row['dept']}</option>			              		            
																</select>
																</td>	
									                       </tr>
									                       <tr>
									                           ...
									                           <td class='datab-2'><textarea class='txtarea' id='dwmc'name='sfz'>{$row['sfz']}</textarea></td>
									                           <td class='datab-1 tdtitle'>电话</td>
									                           <td class='datab-2'><textarea class='txtarea' id='htmc'name='phone'>{$row['phone']}</textarea></td>
									                           <td class='datab-1 tdtitle'>银行账号</td>
									                           <td class='datab-2'><textarea class='txtarea' id='htmc'name='bank'>{$row['bank']}</textarea></td>
									                       </tr>
									                       <tr>                        
									                           <td class='datab-1 tdtitle'>入职时间</td>
									                           <td class='datab-2'><span class='ace-calendar-picker' style='width:100%;'>
																				<div>
																					<input  id='dpStart' placeholder='' name='rzsj' value='{$row['rzsj']}'autocomplete='off' type='text' class='ace-calendar-picker-input ace-input'style='width: 100%;height: 60%;color:black'>
																					<span class='ace-calendar-picker-icon'>							
																					</span>
																					</div>
																					</span></td>
									                           <td class='datab-1 tdtitle'>备注</td>
									                           <td class='datab-2'><textarea class='txtarea' name='bz' id='htgq'>{$row['bz']}</textarea></td>
									                       </tr>
