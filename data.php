...
<html>
	<head>
		...
		<body marginwidth="0" marginheight="0">
			...
			<div class="col-sm-12">
						         ...
						         <fieldset>
						             <div class="form-group">
						                 <div style="float: right;">
						         									...
						         									<a href="data_bytime.php" id="exit" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" ><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">按时间查看</span><span class="l-btn-icon icon-exit">&nbsp;</span></span></a>
				 ...
				 <div style="display: ;" id='table_xmbh'>
					 <center><h2 style='font-size:25px;text-align:center'>员工年度表</h2></center>
		<table style="word-break:break-all; word-wrap:break-all;" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%"id="tb_user" >
				...
				<center><h2 style='font-size:25px;text-align:center'>月度详细表</h2></center>
												      ...
												      //               },
																	...
																	// width:140,
																	                        formatter: function (value, row, index) {//这里的三个参数：value表示当前行当前列的值；row表示当前行的数据；index表示当前行的索引（从0开始）。
																								var html = '<a href="javascript:;" onclick="detail(\''+row.nd+'\',\''+row.company+'\',\''+row.dept+'\',\''+row.name+'\')" title="导出详细记录" class=" l-btn l-btn-small l-btn-plain"  group=""><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text"></span><span class="l-btn-icon icon-export">&nbsp;</span></span></a>';
																	                            return html;
																	                        },
			...
			///////////////////////////////////////////////收支详细表///////////////////////////////////////////////////////////////////////
				...
				<script>
				function detail(nd,company,dept,name){
					window.location.href= "excel_data_byname.php?nd=" + nd + "&company=" + company+"&dept="+dept+"&name="+name ;
								}		
			</script>
</html>