        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <!-- /.box-header -->
                    <h3><span>奖金信息录入表</span></h3>
                    <table>
                        <tr>
							<td class="datab-1 tdtitle">日期</td>
							<td class="datab-2"><input type="month"class="txtarea" id='date'name="setting[date]"></td>
                            <td class="datab-1 tdtitle">姓名</td>
                            <td class="datab-2"><textarea class="txtarea" id='name'name="setting[name]"></textarea></td>
                        ...
                        <tr>
                            ...
                            <td class="datab-2"><textarea class="txtarea" id='dwmc'name="setting[xz]"></textarea></td>
                            <td class="datab-1 tdtitle">市场经营</td>
                            <td class="datab-2"><textarea class="txtarea" id='htmc'name="setting[sc]"></textarea></td>
                            <td class="datab-1 tdtitle">项目研发</td>
                            <td class="datab-2"><textarea class="txtarea" id='htmc'name="setting[xm]"></textarea></td>
                        </tr>
                        <tr>                        
                          <td class="datab-1 tdtitle">质量保障</td>
                          <td class="datab-2"><textarea class="txtarea" id='dwmc'name="setting[zl]"></textarea></td>
                          <td class="datab-1 tdtitle">软件实施</td>
                          <td class="datab-2"><textarea class="txtarea" id='htmc'name="setting[rj]"></textarea></td>
                          <td class="datab-1 tdtitle">数据实施</td>
                          <td class="datab-2"><textarea class="txtarea" id='htmc'name="setting[sj]"></textarea></td>
                        </tr>
						<tr>
						  <td class="datab-1 tdtitle">集成实施</td>
						  <td class="datab-2"><textarea class="txtarea" id='dwmc'name="setting[jc]"></textarea></td>
						  <td class="datab-1 tdtitle">交通津贴</td>
						  <td class="datab-2"><textarea class="txtarea" id='htmc'name="setting[jt]"></textarea></td>
						  <td class="datab-1 tdtitle">全员经营</td>
						  <td class="datab-2"><textarea class="txtarea" id='htmc'name="setting[qy]"></textarea></td>
						</tr>
						<tr>
						  <td class="datab-1 tdtitle">经理层考核</td>
						  <td class="datab-2"><textarea class="txtarea" id='dwmc'name="setting[jl]"></textarea></td>
						  <td class="datab-1 tdtitle">备注</td>
						  <td class="datab-2"><textarea class="txtarea" id='htmc'name="setting[bz]"></textarea></td>
