 ...
 <fieldset>
			                  <div class="form-group">
								  <div class="col-sm-2" style="width:106px">
								    ...
								    <div class="col-sm-2">
								          <select name="company" class="form-control" onchange="func()" id="company" style="height:36px;outline:0;margin-top: -5px;">
			              ...
			              <fieldset>
			                  <div class="form-group" >
			                      <div  style="float: right;">
									...
									<a href="javascript:;" id="import" title="点击导入记录" onclick="inportExcel()" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" iconcls="icon-import" plain="true" group=""><span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">导入奖金</span><span class="l-btn-icon icon-import">&nbsp;</span></span></a>
		...
		<thead>
		  <tr style="background-color:#438eb9;color: #FFF;">
			...
			<th class="tr-th" style="text-align:center;padding:10px">行政考核</th>
			<th class="tr-th" style="text-align:center;padding:10px">市场经营</th>
			<th class="tr-th" style="text-align:center;padding:10px">项目研发</th>
			<th class="tr-th" style="text-align:center;padding:10px">质量保障</th>
			<th class="tr-th" style="text-align:center;padding:10px">软件实施</th>
			<th class="tr-th" style="text-align:center;padding:10px">数据实施</th>
			<th class="tr-th" style="text-align:center;padding:10px">集成实施</th>
			<th class="tr-th" style="text-align:center;padding:10px">交通津贴</th>
			<th class="tr-th" style="text-align:center;padding:10px">全员经营</th>
			<th class="tr-th" style="text-align:center;padding:10px">经理考核</th>
			<th class="tr-th" style="text-align:center;padding:10px">实发奖金</th>
		...
		<script>
			...
			$("#add").click(function(){
				...
				layer.open({
					 ...
					 closeBtn: 1,
					 anim: 2,
					 content: "bonus_luru.php?user="+user,
					  // btn: ["", "取消"],
		...
		$("#button").click(function(){
					...
					success:function(msg){
									...
									var   data = eval("("+msg+")"); //将返回的json数据进解析，并赋给data									
										...
										function excel_select(ids) {
											window.location.href= "excel_bonus_select.php?id=" + ids ;
													}
				...
				//修改
					function ShowEdit(id){
						...
						layer.open({
							 ...
							 closeBtn: 1,
							 anim: 2,
							 content: "bonus_change.php?id=" + id,
							  // btn: ["", "取消"],
									...
									var nd = $("#yf").val();
									 if(dept=="" &&  name=="" && nd==""&& yf=="" ){
											layer.open({
											 ...
											 offset:'t',  //设置弹出位置
											 shadeClose: true,
											 content: 'delete_bonus.php?dept=' + dept + '&name=' + name + '&nd=' + nd+ '&yf=' + yf ,
											 ...
											 yes: function (index, layero) {
												 var thisIndex = index;
												  ...
												  layer.confirm('<h4 style="color:red;padding:5px5px;magin:2px;">警告：真的确定清空表中所有数据吗</h4></center>', { icon: 5, title: '提示' }, function (index) {
														window.location.href= "delete_bonus_php.php?dept=" + dept + "&name=" + name + "&phone=" + phone ;										                                									                 
																																			});
																			},//layer嵌套  *****重要
														});
														}else{
			...
			<script>
				...
				function excel(){				
					...
					// window.open(url, "_blank");
					window.location.href= "excel_bonus.php?dept=" + dept + "&name=" + name + "&nd=" + nd+ "&yf=" + yf+"&company="+company;
								}
